...
regimes (CS\,+\,PV median $0.995$), while VS median forecast $R^2$
...
An $N$-convergence study on pure Vicsek confirms mean-field
convergence at moderate particle counts (Appendix~\ref{app:n_convergence}),
but a full cross-regime convergence analysis was not attempted.
...
properties of the physics or of the smoothing; this is the most immediate
