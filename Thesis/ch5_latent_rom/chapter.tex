...
The unknown parameters $(A_0,\{A_j\}_{j=1}^w)$ are obtained by minimizing a ridge-penalized least-squares problem:
...
mitigates vanishing/exploding gradients~\cite{hochreiter1997lstm}, which matters when the latent
...
The final hidden state is passed through LayerNorm before a linear readout.
...
ground-truth latent states, optimised with Adam; early stopping,
...
horizons. It is not a leaderboard-style predictor comparison.
