...
dataset and learn MVAR and LSTM evolution maps;
...
uses for prediction.  We evaluate BIC, HQIC, and AIC on unrestricted
...
spatial mean~$\bar\rho^n$ (a single scalar per frame), so $R^2$ values
