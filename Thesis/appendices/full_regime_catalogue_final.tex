...
---$^*$ = MVAR not evaluated for preprocessing ablation variants.}
\label{tab:full_regime_catalogue}
\input{appendices/catalogue_table_final}
\end{table}
...
WSINDy identification was performed on the nine primary benchmark
regimes (Chapter~\ref{ch:wsindy_results}).  The EF-ROM forecast $R^2$
values for all regimes are recorded in
Table~\ref{tab:full_regime_catalogue} above.
