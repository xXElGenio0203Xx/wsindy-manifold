...
\end{equation}
This is the standard Vicsek alignment mechanism~\cite{vicsek1995vicsek,ginelli2015physics}; its mean-field limit and the continuum equations that arise from it are studied in~\cite{toner2005hydrodynamics,bertin2006boltzmann,degond2008continuum}.
...
This follows from standard properties of Gaussian convolution.
\end{remark}
