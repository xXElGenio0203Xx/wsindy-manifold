...
def main():
    ...
    # Determine lag for each model separately
    # MVAR builds its own dataset internally from rom_config, so the "shared"
    # dataset here is primarily for LSTM. We keep it for backward compat.
    ...
    # Build shared windowed dataset (MVAR trainer builds its own internally)
